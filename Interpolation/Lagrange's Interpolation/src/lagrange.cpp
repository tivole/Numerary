...
#define N 11
#define TEST_N 51
#define FUNCTION_WITH_STRING "1.0/(1.0+x*x)"
...
int main()  {
    ...
    fprintf(f_gplot, "\t'input_xy.csv' with points ls 5 lc rgb '#00ff00' ps 1.3 title 'Input Values', \\\n");
    fprintf(f_gplot, "\t'lagrange_xy.csv' with linespoints ls 7 lc rgb '#ff0000' lw 1.2 dt 2 ps 0.7 title 'Lagrange Polynom'\n\n");
